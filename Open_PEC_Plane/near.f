      subroutine near(bs,xx,yy,x1,y1,dx,dy,rxx,rxy,ryy)
      parameter (n0=20,ne=4)
      dimension x(ne),y(ne),d0(ne),t0(ne),t1(ne),t2(ne),t10(ne),t20(ne)
...
c----------
 ...
 3      aa=y(k1)-y(k)
        ...
        d2=sqrt((x(k1)-x0)**2+(y(k1)-y0)**2)
           ...
           if (xa.lt.0..and.ya.lt.0.) goto 6
           if (xa.ge.0..and.ya.lt.0.) goto 7
           goto 10
 ...
 10        if (x(k).ge.0..and.y(k).ge.0.) goto 24
           if (x(k).lt.0..and.y(k).ge.0.) goto 25
           if (x(k).lt.0..and.y(k).lt.0.) goto 26
           if (x(k).ge.0..and.y(k).lt.0.) goto 27
           goto 18
 24           t1(k)=asin(abs(y(k)/d1))
           goto 18
 25           t1(k)=pi-asin(abs(y(k)/d1))
           goto 18
 26           t1(k)=-pi+asin(abs(y(k)/d1))
           goto 18
 27           t1(k)=-asin(abs(y(k)/d1))
 18        if (x(k1).ge.0..and.y(k1).ge.0.) goto 34
           if (x(k1).lt.0..and.y(k1).ge.0.) goto 35
           if (x(k1).lt.0..and.y(k1).lt.0.) goto 36
           if (x(k1).ge.0..and.y(k1).lt.0.) goto 37
           goto 30
 34           t2(k)=asin(abs(y(k1)/d2))
           goto 30
 35           t2(k)=pi-asin(abs(y(k1)/d2))
           goto 30
 36           t2(k)=-pi+asin(abs(y(k1)/d2))
           goto 30
 37           t2(k)=-asin(abs(y(k1)/d2))
 30   t10(k)=t1(k)-t0(k)
      t20(k)=t2(k)-t0(k)
 1    continue
c-----------
